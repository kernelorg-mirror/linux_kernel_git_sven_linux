...
#define BTN_POWER		0x01 /* power button on e.g. Mac Mini chasis */
#define BTN_TOUCHID		0x06 /* combined TouchID / power button on MacBooks */
#define BTN_POWER_HELD_SHORT	0xfe /* power button or TouchID held down for ~TODO */
#define BTN_POWER_HELD_LONG	0x00 /* power button or TouchID held down for ~TODO */
...
static void macsmc_hid_event_button(struct macsmc_hid *smchid, unsigned long event)
{
	...
	case BTN_POWER_HELD_LONG:
		/*
		 * If we get here the oower button has been held down for TODO and
