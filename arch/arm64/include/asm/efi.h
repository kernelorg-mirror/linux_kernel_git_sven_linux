 ...
 *                returned by PSCI_VERSION (major in bits 16-31, minor in
 *                bits 0-15).
 * @pad:          Reserved. Makes the padding required to naturally align
 *                @psci_handler explicit.
 ...
 * (LINUX_EFI_ARM_PSCI_HANDLER_TABLE_GUID). @version and @features contain
 * the answers to the PSCI calls that must be serviced before EFI runtime
 * services can be invoked. All other calls are forwarded to
